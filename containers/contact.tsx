  ...
  return (
    <section id='contact' className='scroll-mt-28'>
      <Container>
            ...
            <div className='grid gap-12 xl:grid-cols-[1.05fr_1fr] xl:gap-20'>
              <div className='space-y-8 font-stabil text-lg xl:text-2xl'>
                <div className='flex items-start gap-4'>
                  <MapPin className='mt-1 h-6 w-6 shrink-0 text-black/45 xl:h-7 xl:w-7' />
                  <div>
                ...
                <div className='flex items-start gap-4'>
                  <Mail className='mt-1 h-6 w-6 shrink-0 text-black/45 xl:h-7 xl:w-7' />
                  <a href='mailto:ciao@rozmluv.se'>ciao@rozmluv.se</a>
                </div>

                <div className='flex items-start gap-4'>
                  <Phone className='mt-1 h-6 w-6 shrink-0 text-black/45 xl:h-7 xl:w-7' />
                  <div>
                    <p>
                      Adriana Černá{' '}
                ...
                >
                  ...
                  {language === 'ua' && 'Слідкувати за novinami →'}
                </button>
                */}
                <button
        ...
        <div className='mt-10 grid grid-cols-2 gap-4 xl:gap-8'>
