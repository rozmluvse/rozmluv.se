        ...
        <div className='mt-14'>
          ...
          <div className='mt-8 grid grid-cols-2 gap-6 sm:grid-cols-4 lg:hidden'>
            {teamLectors.map((lector, index) => (
              <div
                key={lector.slug?.current || lector.name}
                className={getMobileTeamVisibility(index, showAllTeam)}
              >
                {renderTeamCard(lector, '(min-width: 640px) 25vw, 50vw')}
              </div>
            ))}
          </div>
            ...
            {desktopTeamPagesCount > 0 && (
              <div className='mt-8 overflow-hidden'>
                <div
                  ...
                  style={{
                    width: `${desktopTeamPagesWidth * 100}%`,
                    transform: `translateX(-${activeDesktopTeamPage * (100 / desktopTeamPagesWidth)}%)`,
                  }}
                >
            ...
            {desktopTeamPagesCount > 1 && (
              <div className='mt-8 flex items-center gap-2'>
                ...
                <button
                  ...
                  disabled={activeDesktopTeamPage === desktopTeamPagesCount - 1}
                >
                  <ArrowRight size={18} />
                </button>
              </div>
