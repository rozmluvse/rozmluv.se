      ...
      <Container className='grid gap-4 lg:gap-10 lg:grid-cols-2'>
        ...
        <div>
          ...
          <p className='mb-6'>
            ...
            {language === 'ua' &&
              'Бачення Бари, яке відображено в житті всієї мовної школи, полягає в тому, щоб не призначати студентам d.cv. на сторінці 7, але змінити своє життя на краще. Мотивувати їх, підштовхнути, допомогти досягти їхніх мрій. Вona завжди сприймала своїх учнів як надихаючих людей, які можуть її багато чому навчити. З іноземцями вона із захопленням вбирає їх мову та культурні відмінності.'}
          </p>
          <p className='mb-6'>
            {language === 'cz' &&
